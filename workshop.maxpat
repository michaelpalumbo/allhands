...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 759.0, 649.0, 282.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.5, 347.0, 400.0, 20.0 ],
					"text" : "These are your outgoing OSC messages (must be sent on port 7404)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 682.0, 677.0, 401.0, 115.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.5, 369.0, 400.0, 197.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 682.0, 614.0, 72.0, 22.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 682.0, 649.0, 50.5, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 101.0, 354.0, 22.0, 22.0 ],
									"text" : "t b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 101.0, 321.0, 60.0, 22.0 ],
									"text" : "zl.change"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 101.0, 223.0, 40.0, 22.0 ],
									"text" : "zl.thin"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 101.0, 100.0, 55.0, 22.0 ],
									"text" : "zl.slice 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 101.0, 131.0, 31.0, 22.0 ],
									"text" : "t b s"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 113.0, 161.0, 96.0, 22.0 ],
									"text" : "prepend append"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 256.0, 520.0, 72.0, 22.0 ],
									"text" : "prepend set"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 256.0, 454.0, 150.0, 60.0 ],
									"presentation" : 1,
									"presentation_linecount" : 2,
									"presentation_rect" : [ 32.0, 13.0, 391.0, 33.0 ],
									"text" : "New Address Pattern Available to receive data from\nSelect + Copy the text:"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 101.0, 525.0, 67.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "front" ],
									"patching_rect" : [ 101.0, 492.0, 39.0, 22.0 ],
									"text" : "t front"
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 110.5, 255.0, 459.0, 255.0, 459.0, 180.0, 433.5, 180.0 ],
									"order" : 0,
									"source" : [ "obj-33", 0 ]
								}
...
,
					"patching_rect" : [ -19.0, 319.0, 181.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"text" : "p new_OSC_Address_Received"
				}
...
, 			{
				"box" : 				{
					...
					"outputmode" : 0,
					"parameter_enable" : 0,
					"patching_rect" : [ 62.0, 365.0, 100.0, 20.0 ],
					"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 31.0, 174.5, 490.0, 163.0 ],
									"presentation" : 1,
									"presentation_linecount" : 10,
									"presentation_rect" : [ 3.0, 90.0, 490.0, 163.0 ],
...
,
					"patching_rect" : [ 62.0, 393.0, 49.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 214.0, 419.5, 150.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 422.5, 73.0, 239.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 168.0, 283.0, 225.0, 22.0 ],
					"text" : "route OSC pingTimes thisPing localSend"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 422.5, 95.0, 400.0, 220.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 17.0, 321.0, 33.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 62.0, 425.0, 54.0, 22.0 ],
					"text" : "onecopy"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 413.0, 254.0, 400.0, 220.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"angle" : 270.0,
					"bgcolor" : [ 0.713725490196078, 0.698039215686274, 1.0, 0.49 ],
					"id" : "obj-33",
					"maxclass" : "panel",
					"mode" : 0,
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 912.0, 461.0, 128.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -1.5, 319.0, 416.0, 263.0 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					"angle" : 270.0,
					"bgcolor" : [ 0.698039215686274, 0.831372549019608, 1.0, 0.49 ],
					"id" : "obj-35",
					"maxclass" : "panel",
					"mode" : 0,
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 927.0, 476.0, 128.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 413.5, 319.0, 416.0, 263.0 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					"angle" : 270.0,
					"bgcolor" : [ 0.905882352941176, 0.372549019607843, 0.372549019607843, 0.36 ],
					"id" : "obj-37",
					"maxclass" : "panel",
					"mode" : 0,
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 942.0, 491.0, 128.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 413.5, 28.0, 416.0, 291.0 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					"angle" : 270.0,
					"bgcolor" : [ 0.0, 0.776470588235294, 0.317647058823529, 0.47 ],
					"id" : "obj-36",
					"maxclass" : "panel",
					"mode" : 0,
					"numinlets" : 1,
					...
					"patching_rect" : [ 927.0, 476.0, 128.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -1.5, 28.0, 416.0, 291.0 ],
					"proportion" : 0.5
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 400.5, 251.0, 422.5, 251.0 ],
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 204.0, 180.5, -9.5, 180.5 ],
					"order" : 1,
					"source" : [ "obj-18", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"midpoints" : [ 30.5, 92.0, 120.75, 92.0, 120.75, 48.0, 137.0, 48.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 284.5, 214.5, 177.5, 214.5 ],
					"source" : [ "obj-9", 0 ]
				}
